...
density_factor = 0.2 #This parameter is opposite to sparsity factor, for an FC
					 # network its 1.0.
    ...
    if isinstance(layer, nn.Conv2d):
        ...
        for i in range(tmp1[0]):
            ...
            for j in range (tmp1[1]):
                ...
                if (k!=1 and (cnt_inCh % 8 == 1) and tmp1[2] != 1):
                    tmp3 = np.array([1] * 2 + [0] * 7)
                elif (k!=1 and (cnt_inCh % 8 == 2) and tmp1[2] != 1):
                    tmp3 = np.array([0] * 1 + [1] * 2 + [0] * 6)
                elif (k!=1 and (cnt_inCh % 8 == 3) and tmp1[2] != 1):
                    tmp3 = np.array([0] * 3 + [1] * 2 + [0] * 4)
                elif (k!=1 and (cnt_inCh % 8 == 4) and tmp1[2] != 1):
                    tmp3 = np.array([0] * 4 + [1] * 2 + [0] * 3)
                elif (k!=1 and (cnt_inCh % 8 == 5) and tmp1[2] != 1):
                    tmp3 = np.array([0] * 6 + [1] * 2 + [0] * 1)
                elif (k!=1 and (cnt_inCh % 8 == 6) and tmp1[2] != 1):
                    tmp3 = np.array([0] * 7 + [1] * 2)
                elif (k!=1 and (cnt_inCh % 8 == 7) and tmp1[2] != 1):
                    tmp3 = np.array([1] * 2 + [0] * 7)
                elif (k!=1 and (cnt_inCh % 8 == 0) and tmp1[2] != 1):
                    tmp3 = np.array([1] * 9)
                elif (tmp1[2] == 1):
                    tmp3 = np.array([1] * 1)
                else:
